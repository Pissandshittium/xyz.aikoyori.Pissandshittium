...
for size in 24 48 64 128 256; do
    install -Dvm 644 chrome/app/theme/chromium/linux/product_logo_$size.png /app/share/icons/hicolor/${size}x${size}/apps/xyz.aikoyori.Pissandshittium.png;
done
install -Dvm 644 cobalt.ini -t /app/etc
install -Dvm 644 xyz.aikoyori.Pissandshittium.desktop -t /app/share/applications
install -Dvm 644 xyz.aikoyori.Pissandshittium.metainfo.xml -t /app/share/metainfo
